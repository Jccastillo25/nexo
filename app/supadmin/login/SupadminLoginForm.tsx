...
export function SupadminLoginForm({
  productName,
  logoUrl,
  copyrightText,
}: {
      ...
      <div className="mx-auto w-full max-w-sm">
        <div className="mb-1 flex items-center gap-3">
          {logoUrl && (
            ...
            <img src={logoUrl} alt={productName} className="h-9 w-9 rounded-lg object-contain" />
          )}
          <h1 className="text-2xl font-bold">{productName} · Super Admin</h1>
        </div>
