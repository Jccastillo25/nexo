...
export interface BackToPanelLinkProps {
  ...
  label?: string;
  /** Override de estilo para que cada modulo lo integre a su propia
   * paleta (ver Header.tsx de apps/crm). Sin esto, un estilo neutro que
   * funciona sobre el shell oscuro de ShellBar. */
  className?: string;
}

const DEFAULT_CLASS =
  "inline-flex items-center gap-1.5 text-sm text-neutral-400 transition-colors hover:text-neutral-50";
