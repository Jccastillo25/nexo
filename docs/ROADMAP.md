...
| 3 | Adaptar `web-corporativo` + `crm` (basePath, Supabase → `nexo-core`) | ✅ Hecho (2026-08-30) — falta el paso manual de exponer el schema `crm` y copiar datos reales, ver [MIGRATION_LOG.md](MIGRATION_LOG.md) |
