...
Última actualización documental: **2026-09-07** (Nexo Enterprise UI —
rediseño visual transversal de `packages/ui`/`apps/nexo`/`apps/rrhh`/
`apps/crm`, ejecutado y con las 2 migraciones nuevas verificadas via RPC
real; ver sección 0.15. Antes de eso, F1.4 — Jornadas mínimas, sección
0.14).
